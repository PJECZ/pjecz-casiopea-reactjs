...
const NewAppointment: React.FC = () => {
    ...
    // ─── Lógica de Efectos ────────────────────────────────
    useEffect(() => {
        getDistritos().then(res => setDistritos(res)).finally(() => setLoading(false));
    }, []);
    ...
    useEffect(() => {
        ...
        getOficinasFiltradas(distrito).then(res => setOficinas(res)).finally(() => setLoading(false));
    }, [distrito]);
    ...
    useEffect(() => {
        ...
        getServiciosPorOficina(oficina.clave).then(res => setTramites(res)).finally(() => setLoading(false));
    }, [oficina]);
    ...
    useEffect(() => {
        ...
        getFechasDisponibles(oficina.clave, tramite).then(res => setFechas(res)).finally(() => setLoadingFechas(false));
    }, [oficina, tramite]);
    ...
    useEffect(() => {
        ...
        getHorasDisponibles(oficina.clave, tramite, fecha.format('YYYY-MM-DD')).then(res => setHoras(res)).finally(() => setLoadingHoras(false));
    ...
    useEffect(() => {
        ...
        // Escuchamos el evento personalizado que lanza authFetch
